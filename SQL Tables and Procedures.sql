...
INSERT INTO `tbl_book_copies` VALUES (1,1,10),(1,2,1),(1,3,2),(1,4,3),(2,1,1),(2,2,40),(2,3,2),(2,4,0),(3,1,2),(3,2,1),(3,3,0),(3,4,1);
...
INSERT INTO `tbl_book_loans` VALUES (1,2,1,'2019-12-02 12:00:00','2019-12-08 00:00:00');
...
INSERT INTO `tbl_borrower` VALUES (1,'Jane','404','999'),(2,'John','405','100'),(3,'Joe','406','101'),(4,'Matt','4630','218');
...
INSERT INTO `tbl_library_branch` VALUES (1,'University Library','Boston'),(2,'test state','test lane'),(3,'Federal Library','Washington DC'),(4,'County Library','McLean VA');
...
INSERT INTO `tbl_publisher` VALUES (1,'name','23','999999999'),(2,'Collins','645 True','147'),(3,'Harper','441 re','369');
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `adminAddBa`(IN bName VARCHAR(255), aName VARCHAR(255), pId INT)
BEGIN
...
SET bl.dueDate = due
WHERE bl.cardNo = cNo AND bl.bookId = bId AND bl.branchId = brId;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2019-12-21 22:21:35
